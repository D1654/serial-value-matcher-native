...
inline constexpr int kNativeDefaultWindowWidth = 1220;
inline constexpr int kNativeDefaultWindowHeight = 780;
inline constexpr int kNativeMinWindowWidth = 760;
inline constexpr int kNativeMinWindowHeight = 520;
inline constexpr int kNativeMaxWindowWidth = 16384;
inline constexpr int kNativeMaxWindowHeight = 9216;
