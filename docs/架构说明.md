...
状态：过渡参考。当前 Win32 native 架构入口请优先阅读 [Win32原生架构.md](Win32原生架构.md)。Qt 历史路线请阅读 [Qt历史说明.md](Qt历史说明.md)。

当前仓库保留两条实现路线：Win32 native 轻量发布路线和 Qt 历史基线路线。v1.0.4 面向用户发布的是 Win32 native 包。
