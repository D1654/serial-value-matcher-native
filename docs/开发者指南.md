...
- `docs/`：当前文档以 Win32 native 为主，旧 Qt 说明集中到 `docs/Qt历史说明.md`。
...
- `serial-pty-matrix-summary.txt` 包含 `GateStatus=passed` 和 `Classification=local-only-release-candidate-evidence`。
